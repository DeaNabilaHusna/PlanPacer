...
<div class="hidden lg:block w-1/2 bg-defwhite h-full relative">
    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 md:mx-auto md:w-full md:max-w-sm">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm text-defwhite">
            ...
            <form class="space-y-6 mt-2" action="#" method="POST">
                <!-- Input Nama Pengguna -->
                <div>
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input id="phone" name="phone" type="tel" autocomplete="phone" required class="block w-full rounded-md border-0 px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
