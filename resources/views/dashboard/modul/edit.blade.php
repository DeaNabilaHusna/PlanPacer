    ...
    <form method="post" action="/main-menu/proyek/{{ $proyek->slug }}/modul/{{ $kartuTugas->id}}">
        ...
        <div class="max-w-screen-xl mx-auto bg-white p-8 rounded-md shadow-md w-1113 h-830">
            <div class="mb-4">
                ...
                <input type="text" id="nama_kartu" name="nama_kartu" class="w-full border rounded-md p-2" value="{{ old('nama_kartu', $kartuTugas->nama_kartu) }}" required>
                @error('nama_kartu')
