            ...
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="flex items-center lg:order-2">
                    <div class="flex justify-center">
                        <button type="submit"
                            class="w-28 rounded-md bg-yellow px-3 py-1.5 text-sm font-semibold leading-6 text-defwhite shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Gabung</button>
                    </div>
                ...
                <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1 ml-auto mr-7"
                    id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li>
                            <a href="#"
                                class="block py-2 pr-4 pl-3 text-defwhite p-0 hover:text-yellow focus:text-yellow">Home</a>
                        </li>
                        <li>
                            <a href="#"
                                class="block py-2 pr-4 pl-3 text-defwhite p-0 hover:text-yellow focus:text-yellow">Fitur</a>
                        </li>
                        <li>
                            <a href="#"
                                class="block py-2 pr-4 pl-3 text-defwhite p-0 hover:text-yellow focus:text-yellow">Panduan</a>
                        </li>
                        <li>
                            <a href="#"
                                class="block py-2 pr-4 pl-3 text-defwhite p-0 hover:text-yellow focus:text-yellow">Tentang
                                Kami</a>
                        </li>
                    </ul>
                </div>
