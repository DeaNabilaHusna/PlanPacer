...
Route::group(['middleware' => ['role:user|super admin|admin|project manager|analyst|designer database|designer ui/ux|programmer|implementator|quality control|designer database']], function () {
    ...
    // Proyek
    Route::get('/main-menu/proyek', [ProjectController::class, 'index'])->middleware('permission:lihat proyek');
    Route::get('/main-menu/proyek/create', [ProjectController::class, 'create'])->middleware('permission:buat proyek');
    Route::post('/main-menu/proyek', [ProjectController::class, 'store'])->middleware('permission:buat proyek');
    Route::get('/main-menu/proyek/{slug}', [ProjectController::class, 'show'])->middleware('permission:lihat proyek');
    ...
    // Tugas
    Route::get('/main-menu/tugas', [TugasController::class, 'index'])->middleware('permission:lihat tugas');
